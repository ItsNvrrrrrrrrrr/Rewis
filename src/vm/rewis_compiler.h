#ifndef rewis_compiler_h
#define rewis_compiler_h
...
// This module defines the compiler for Rewis. It takes a string of source code
// and lexes, parses, and compiles it. Rewis uses a single-pass compiler. It
...
// Compiles [source], a string of Rewis source code located in [module], to an
